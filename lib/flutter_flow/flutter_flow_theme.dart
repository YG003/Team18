...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF84DCC6);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF4B4E6D);
  late Color alternate = const Color(0xFF84DCC6);
  late Color primaryText = const Color(0xFF020810);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFBF1919);
  ...
  late Color eerieBlack = Color(0xFF222222);
  late Color white = Color(0xFFFFFFFF);
  late Color ultraViolet = Color(0xFF4B4E6D);
  late Color tiffanyBlue = Color(0xFF84DCC6);
  late Color cadetGray = Color(0xFF95A3B3);
}
