...
class _LawyerHomeWidgetState extends State<LawyerHomeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LawyerHomeModel());
  }
            ...
            children: [
              Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 20.0, 0.0, 16.0),
                    child: Text(
                      'Chat Requests',
                      style:
